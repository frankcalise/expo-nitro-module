...
namespace margelo::nitro::example::bridge::swift {
  ...
  /**
   * Specialized version of `std::shared_ptr<margelo::nitro::example::HybridMathSpec>`.
   */
  using std__shared_ptr_margelo__nitro__example__HybridMathSpec_ = std::shared_ptr<margelo::nitro::example::HybridMathSpec>;
  ...
  // pragma MARK: std::weak_ptr<margelo::nitro::example::HybridMathSpec>
  using std__weak_ptr_margelo__nitro__example__HybridMathSpec_ = std::weak_ptr<margelo::nitro::example::HybridMathSpec>;
  inline std__weak_ptr_margelo__nitro__example__HybridMathSpec_ weakify_std__shared_ptr_margelo__nitro__example__HybridMathSpec_(const std::shared_ptr<margelo::nitro::example::HybridMathSpec>& strong) { return strong; }
